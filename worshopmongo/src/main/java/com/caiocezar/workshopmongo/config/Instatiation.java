package com.caiocezar.workshopmongo.config;
...
import com.caiocezar.workshopmongo.dto.AuthorDTO;
...
public class Instatiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		userRepository.deleteAll();//aqui esta zerando minha coleção, no banco
